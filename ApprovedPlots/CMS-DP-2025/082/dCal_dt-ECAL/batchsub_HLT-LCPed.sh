...
CFG_FILE="/afs/cern.ch/user/j/jprendi/LCtimeseries/src/hltSub/dumpLCPed.py"
...
EOS_BASE="/eos/cms/store/group/tsg-phase2/user/jprendi/PrLCPed_Run2024I_386"
...
for file in "$FILELIST_DIR"/fileList_*.txt; do
    ...
    folder_name="${file_number}_LCPed"
