...
CFG_FILE="/afs/cern.ch/user/j/jprendi/LCtimeseries/src/hltSub/dumpPrompt.py"
...
EOS_BASE="/eos/cms/store/group/tsg-phase2/user/jprendi/PrPrompt_Run2024I_386"
...
for file in "$FILELIST_DIR"/fileList_*.txt; do
    ...
    folder_name="${file_number}_Prompt"
