...
def bar_panels(
    ...
    # Add CMS Preliminary label at top-left
    #fig.text(0.05, 0.95, "CMS Preliminary", fontsize=14, fontweight="bold", ha="left", va="top")

    # Add CMS Preliminary (left) and PU info (right) at top
    fig.text(
        0.05, 0.95,
...
def main():
    ...
    metric_label = args.metric.replace("_", " ") + (" (per event) [ms]" if args.per_event else "")
